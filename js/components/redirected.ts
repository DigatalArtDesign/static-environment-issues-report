...
import InjuredFromAttack  from "../classes/form-data/InjuredFromAttack";
import InjureType from "../classes/form-data/InjureType";
import AmountOfInjures from "../classes/form-data/AmountOfInjures";
