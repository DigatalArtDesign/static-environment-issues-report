...
})({"4AFR5":[function(require,module,exports) {
var HMR_HOST = null;var HMR_PORT = 1234;var HMR_SECURE = false;var HMR_ENV_HASH = "d751713988987e9331980363e24189ce";module.bundle.HMR_BUNDLE_ID = "782db4583b54efb0effb432f25f536be";/* global HMR_HOST, HMR_PORT, HMR_ENV_HASH, HMR_SECURE */
...
},{}],"7FVtS":[function(require,module,exports) {
var _classesFormData = require("../classes/FormData");
var _parcelHelpers = require("@parcel/transformer-js/lib/esmodule-helpers.js");
var _classesFormDataDefault = _parcelHelpers.interopDefault(_classesFormData);
var _apiApi = require("../api/api");
var _classesDropdown = require("../classes/Dropdown");
var _classesDropdownDefault = _parcelHelpers.interopDefault(_classesDropdown);
"use strict";
document.addEventListener("DOMContentLoaded", () => {
  let formData = new _classesFormDataDefault.default();
  const initForm = () => {
    ...
    Object.keys(formData.type).map((item, index) => document.getElementsByClassName("form-radio-type")[index].checked = formData.type[item]);
    Object.keys(formData.amountOfInjures).map((item, index) => document.getElementsByClassName("form-radio-amount")[index].checked = formData.amountOfInjures[item]);
  ...
  const listenDomMultiselectCollection = (element, formObject, listener = "input", inputClass, isRadio = false) => {
    ...
    for (let i = 0; i < domObject.length; i++) {
      domObject[i].addEventListener(listener, () => {
        ...
        const el = domObject[i].getElementsByClassName(inputClass)[0];
  ...
  const listenDomElement = (elementName, formObject) => {
    ...
    domObject.addEventListener("input", e => {
      formData[formObject] = e.target.value;
    });
  };
  const sendForm = () => {
    ...
    button.addEventListener("click", async () => {
      ...
      await _apiApi.api.sendReport(formData);
  ...
  const createDropdown = async () => {
    const dropdownContent = await _apiApi.api.loadCountries();
    const props = {
    ...
    const drop = new _classesDropdownDefault.default(props);
    console.log(drop);
  };
  createDropdown();
  sendForm();
...
},{"../classes/FormData":"1C8Sq","../api/api":"3Pen2","../classes/Dropdown":"AO4Xy","@parcel/transformer-js/lib/esmodule-helpers.js":"5gA8y"}],"1C8Sq":[function(require,module,exports) {
var _parcelHelpers = require("@parcel/transformer-js/lib/esmodule-helpers.js");
_parcelHelpers.defineInteropFlag(exports);
_parcelHelpers.export(exports, "InjuredFromAttack", function () {
  return InjuredFromAttack;
});
_parcelHelpers.export(exports, "InjureType", function () {
  return InjureType;
});
_parcelHelpers.export(exports, "AmountOfInjures", function () {
  return AmountOfInjures;
});
var _uuid = require("uuid");
var _uuidDefault = _parcelHelpers.interopDefault(_uuid);
class InjuredFromAttack {
  ...
  static deserialize(injured) {
    ...
    for (const propertyName of Object.keys(injured)) {
      if (InjuredFromAttack.propertyDeserializers.has(propertyName)) {
        const deserializer = InjuredFromAttack.propertyDeserializers.get(propertyName);
        temp[propertyName] = deserializer === undefined ? injured[propertyName] : deserializer(temp[propertyName]);
      } else {
  ...
  static propertyDeserializers = new Map([["rareSpecies", undefined], ["ozoneLayer", undefined], ["meanTemperature", undefined], ["plants", undefined], ["rivers", undefined], ["lakes", undefined], ["soil", undefined], ["cities", undefined], ["other", undefined]]);
}
class InjureType {
  ...
  static deserialize(amount) {
    ...
    for (const propertyName of Object.keys(amount)) {
      if (InjureType.propertyDeserializers.has(propertyName)) {
        const deserializer = InjureType.propertyDeserializers.get(propertyName);
        type[propertyName] = deserializer === undefined ? amount[propertyName] : deserializer(amount[propertyName]);
      } else {
        throw Error(`No deserializer for ${propertyName}!`);
      }
    }
  ...
  static propertyDeserializers = new Map([["polutionAssault", undefined], ["arson", undefined], ["endangeredSpeciesPoaching", undefined], ["dump", undefined]]);
}
class AmountOfInjures {
  ...
  static propertyDeserializers = new Map([["minor", undefined], ["medium", undefined], ["severe", undefined]]);
  static deserialize(amount) {
    const injures = new AmountOfInjures();
    for (const propertyName of Object.keys(amount)) {
      if (AmountOfInjures.propertyDeserializers.has(propertyName)) {
        const deserializer = AmountOfInjures.propertyDeserializers.get(propertyName);
        injures[propertyName] = deserializer === undefined ? amount[propertyName] : deserializer(amount[propertyName]);
      } else {
        throw Error(`No deserializer for ${propertyName}!`);
      }
    }
...
class FormData {
  ...
  static create(name, issue, email, id, injuredFromAttack, type, amountOfInjures, description, sentTime) {
    const formData = new FormData();
    formData.name = name;
    formData.issue = issue;
    formData.email = email;
    (formData.id = id, formData.injuredFromAttack = injuredFromAttack, formData.type = type);
    formData.amountOfInjures = amountOfInjures;
    formData.description = description;
    formData.sentTime = sentTime;
    return formData;
  }
  static propertyDeserializers = new Map([["name", undefined], ["email", undefined], ["issue", undefined], ["id", undefined], ["description", undefined], ["sentTime", undefined], ["injuredFromAttack", InjuredFromAttack.deserialize], ["type", InjureType.deserialize], ["amountOfInjures", AmountOfInjures.deserialize]]);
  constructor() {
    this.resetForm();
  }
  resetForm() {
  ...
  static deserialize(formData) {
    ...
    for (const propertyName of Object.keys(formData)) {
      if (FormData.propertyDeserializers.has(propertyName)) {
        const deserializer = FormData.propertyDeserializers.get(propertyName);
        form[propertyName] = deserializer === undefined ? formData[propertyName] : deserializer(formData[propertyName]);
      } else {
        throw Error(`No deserializer for ${propertyName}!`);
      }
    }
...
},{"uuid":"55aGJ","@parcel/transformer-js/lib/esmodule-helpers.js":"5gA8y"}],"55aGJ":[function(require,module,exports) {
var v1 = require('./v1');
var v4 = require('./v4');
...
},{"./lib/rng":"3iwbt","./lib/bytesToUuid":"5sgUX"}],"3iwbt":[function(require,module,exports) {
...
},{}],"5sgUX":[function(require,module,exports) {
/**
...
},{}],"4PdPT":[function(require,module,exports) {
var rng = require('./lib/rng');
var bytesToUuid = require('./lib/bytesToUuid');
...
},{}],"3Pen2":[function(require,module,exports) {
var _parcelHelpers = require("@parcel/transformer-js/lib/esmodule-helpers.js");
_parcelHelpers.defineInteropFlag(exports);
...
class Api {
  constructor() {
    this.http = _axiosDefault.default.create({
      baseURL: "http://localhost:3001"
    });
    this.globalHttp = _axiosDefault.default.create();
  }
  async loadCountries() {
  ...
  async loadReports() {
    ...
    return mapCases.map(i => _classesFormDataDefault.default.deserialize(i));
  }
...
},{"axios":"7rA65","@parcel/transformer-js/lib/esmodule-helpers.js":"5gA8y","../classes/FormData":"1C8Sq"}],"7rA65":[function(require,module,exports) {
...
},{}],"AO4Xy":[function(require,module,exports) {
var _parcelHelpers = require("@parcel/transformer-js/lib/esmodule-helpers.js");
_parcelHelpers.defineInteropFlag(exports);
var _uuid = require("uuid");
var _uuidDefault = _parcelHelpers.interopDefault(_uuid);
...
},{"uuid":"55aGJ","@parcel/transformer-js/lib/esmodule-helpers.js":"5gA8y"}]},["4AFR5","7FVtS"], "7FVtS", "parcelRequire0232")

//# sourceMappingURL=contact.25f536be.js.map
