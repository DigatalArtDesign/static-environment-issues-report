...
})({"2RD5o":[function(require,module,exports) {
var HMR_HOST = null;var HMR_PORT = 1234;var HMR_SECURE = false;var HMR_ENV_HASH = "d751713988987e9331980363e24189ce";module.bundle.HMR_BUNDLE_ID = "acbc799ff4ed003602028d1683f6e0d5";/* global HMR_HOST, HMR_PORT, HMR_ENV_HASH, HMR_SECURE */
...
},{}],"5pwaS":[function(require,module,exports) {
...
function getVideos() {
  ...
  function createImage(element) {
    ...
    const placeholder = element.hasAttribute("data-thumbnail") ? element.getAttribute("data-thumbnail") : "";
    if (placeholder.length) p.innerHTML = createCustomThumbail(placeholder); else p.innerHTML = createThumbail(id);
...
function createCustomThumbail(url) {
  return "<img id=\"youtube-thumbnail\" class=\"youtube-thumbnail\" src=\"" + url + "\" alt=\"Youtube Preview\" /><div id=\"play-btn\" class=\"youtube-play-btn\"></div>";
}
/**
...
},{}]},["2RD5o","5pwaS"], "5pwaS", "parcelRequire0232")

//# sourceMappingURL=about.83f6e0d5.js.map
